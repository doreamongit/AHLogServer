...
- (void)viewDidLoad {
    ...
    out_filename = [[NSString stringWithFormat:@"%@/%@.jpg", [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] ,date] cStringUsingEncoding:NSASCIIStringEncoding];//Output file URL
    
    UIImage *cutImage = [self movieDecode:@"http://n5-pl-agv.autohome.com.cn/video-41/9C9DF5843CD64975/2019-01-05/8FA1D30C74F075BE-200.mp4" withDuration:10];
